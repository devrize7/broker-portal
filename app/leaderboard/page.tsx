...
interface BrokerRow {
  ...
  record: { amount: number; weekOf: string };
}
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="py-4 pl-3 text-right text-xs text-slate-500 tabular-nums">
                          {b.record.weekOf ? new Date(b.record.weekOf + "T12:00:00").toLocaleDateString("en-US") : "—"}
                        </td>
                      </tr>
                    );
                  })}
              ...
              {sortedActive.map((b, i) => {
                ...
                return (
                  ...
                  >
                    ...
                    {b.record.amount > 0 && (
                      <div className="mt-3 pt-2.5 border-t border-white/[0.05] flex items-center gap-1.5 text-xs">
